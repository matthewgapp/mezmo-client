...
pub struct IndexRateAlertConfigChannels {
    ...
    pub webhook: Option<Vec<crate::models::IndexRateAlertWebhookConfig>>,
}

impl IndexRateAlertConfigChannels {
    pub fn new() -> IndexRateAlertConfigChannels {
