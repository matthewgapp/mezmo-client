...
pub struct IndexRateAlertConfigResponse {
    ...
    pub channels: Option<Box<crate::models::IndexRateAlertConfigResponseChannels>>,
    #[serde(rename = "enabled", skip_serializing_if = "Option::is_none")]
    pub enabled: Option<bool>,
}

impl IndexRateAlertConfigResponse {
    pub fn new() -> IndexRateAlertConfigResponse {
