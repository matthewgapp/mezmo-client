...
pub struct ListUsageV2200Response {
    ...
    pub results: Option<Box<crate::models::ListUsageV2200ResponseResults>>,
}

impl ListUsageV2200Response {
    pub fn new() -> ListUsageV2200Response {
        ListUsageV2200Response {
            from: None,
            to: None,
            results: None,
        }
