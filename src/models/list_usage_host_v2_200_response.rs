...
pub struct ListUsageHostV2200Response {
    ...
    pub results: Option<Vec<crate::models::ListUsageHostV2200ResponseResultsInner>>,
}

impl ListUsageHostV2200Response {
    pub fn new() -> ListUsageHostV2200Response {
        ListUsageHostV2200Response {
            from: None,
            to: None,
            results: None,
        }
