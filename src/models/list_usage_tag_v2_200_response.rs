...
pub struct ListUsageTagV2200Response {
    ...
    pub results: Option<Vec<crate::models::ListUsageTagV2200ResponseResultsInner>>,
}

impl ListUsageTagV2200Response {
    pub fn new() -> ListUsageTagV2200Response {
