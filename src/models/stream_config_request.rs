...
/// StreamConfigRequest : Contains settings needed to set up connection(s) to Kafka brokers
...
impl StreamConfigRequest {
    /// Contains settings needed to set up connection(s) to Kafka brokers
    pub fn new(brokers: Vec<String>, topic: String, user: String, password: String) -> StreamConfigRequest {
        StreamConfigRequest {
            brokers,
            topic,
            user,
